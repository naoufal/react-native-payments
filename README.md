...
Naoufal, the original author of this library, has done a lot of the hard work integrating iOS, Android, Web platforms and Stripe gateways.
...
- __Add-ons__. Easily enable support for Stripe via add-ons.

...
function getRandomPrice(min = 0, max = 99) {
    ...
    const priceFloat = (Math.floor(Math.random() * (maxVal - minVal)) + minVal) / multiplier;
...
export function getShippingOptions() {
    return [
        ...
        createShippingOption('express', 'Express Shipping (2-3 Days)', getRandomPrice(5, 10)),
        createShippingOption('next-day', 'Next Day Delivery', getRandomPrice(11, 20)),
    ];
}
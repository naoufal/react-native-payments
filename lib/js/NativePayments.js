...
const NativePayments: {
    ...
    handleShippingContactChange(shippingMethods = [], paymentSummaryItems = []) {
        return new Promise((resolve, reject) => {
            // TODO: review this method
            ReactNativePayments.handleShippingContactChange(shippingMethods, paymentSummaryItems, (err) => {
                if (err) return reject(err);

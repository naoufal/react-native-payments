    ...
    describe('attributes', () => {
        ...
        describe('shippingAddress', () => {
            it('should return `shippingAddress`', () => {
                expect(paymentRequest.shippingAddress).toBe(paymentResponseData.shippingAddress);
            });
        ...
        describe('shippingOption', () => {
            it('should return `shippingOption`', () => {
                expect(paymentRequest.shippingOption).toBe(paymentResponseData.shippingOption);
            });
    ...
    describe('methods', () => {
        describe('complete', () => {
            it('should throw if `_completeCalled` is already true', () => {
                const completedPaymentResponse = createCompletedPaymentResponse(paymentResponseData);

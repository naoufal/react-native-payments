    ...
    describe('methods', () => {
        ...
        describe('abort', () => {
            it('should reject `_state` is not equal to `interactive`', done => {
                const createdPaymentRequest = createCreatedPaymentRequest(METHOD_DATA, DETAILS);

                return createdPaymentRequest.abort()
                .catch(e => {
            ...
            it('should resolve to `undefined`', () => {
                const interactivePaymentRequest = createInteractivePaymentRequest(METHOD_DATA, DETAILS);
            ...
            it('should set `_state` to `closed`', done => {
                ...
                return interactivePaymentRequest.abort()
                .then(() => {

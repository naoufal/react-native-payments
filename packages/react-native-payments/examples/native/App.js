    ...
    return (
      ...
      >
        ...
        <View style={{ padding: 20 }}>
          ...
          <View style={{ marginVertical: 50 }}>
            <Text style={{ color: this.state.type2 === 'plain' ? 'red': 'black' }} onPress={() => this.setState({ type2: 'plain' })}>plain</Text>
            <Text style={{ color: this.state.type2 === 'buy' ? 'red': 'black' }} onPress={() => this.setState({ type2: 'buy' })}>buy</Text>
            <Text style={{ color: this.state.type2 === 'setUp' ? 'red': 'black' }} onPress={() => this.setState({ type2: 'setUp' })}>setUp</Text>
            <Text style={{ color: this.state.type2 === 'inStore' ? 'red': 'black' }} onPress={() => this.setState({ type2: 'inStore' })}>inStore</Text>
            <Text style={{ color: this.state.type2 === 'donate' ? 'red': 'black' }} onPress={() => this.setState({ type2: 'donate' })}>donate</Text>
          </View>
          <View style={{ marginVertical: 50 }}>
